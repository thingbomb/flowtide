...
export const PopoverContent = <T extends ValidComponent = "div">(
  ...
  return (
    <PopoverPrimitive.Portal>
      ...
      >
        {local.children}
        <PopoverPrimitive.CloseButton class="ring-offset-background focus:ring-ring absolute right-4 top-4 rounded-sm p-4 opacity-70 transition-[opacity,box-shadow] hover:opacity-100 focus:outline-none focus:ring-[1.5px] focus:ring-offset-2 disabled:pointer-events-none">
          <svg
